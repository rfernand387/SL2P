...
switch N
    ...
    case 3 
        ...
        domain = i1*10^0+i2*10^1+i2*10^3;
    case 4
        [i1,i2,i3,i4] = ind2sub(size(count),find(count>0));    
        domain = i1*10^0+i2*10^1+i2*10^3+i4*10^4; 
    case 5
        [i1,i2,i3,i4,i5] = ind2sub(size(count),find(count>0));    
        domain = i1*10^0+i2*10^1+i2*10^3+i4*10^4+i5*10^5;  
    case 6
        [i1,i2,i3,i4,i5,i6] = ind2sub(size(count),find(count>0));    
        domain = i1*10^0+i2*10^1+i2*10^3+i4*10^4+i5*10^5+i6*10^6;    
    case 7
        [i1,i2,i3,i4,i5,i6,i7] = ind2sub(size(count),find(count>0));    
        domain = i1*10^0+i2*10^1+i2*10^3+i4*10^4+i5*10^5+i6*10^6+i7*10^7;    
    case 8
        [i1,i2,i3,i4,i5,i6,i7,i8] = ind2sub(size(count),find(count>0));    
        domain = i1*10^0+i2*10^1+i2*10^3+i4*10^4+i5*10^5+i6*10^6+i7*10^7+i8*10^8;   
    case 9
        [i1,i2,i3,i4,i5,i6,i7,i8,i9] = ind2sub(size(count),find(count>0));    
        domain = i1*10^0+i2*10^1+i2*10^3+i4*10^4+i5*10^5+i6*10^6+i7*10^7;    
    case 10
        [i1,i2,i3,i4,i5,i6,i7,i8,i9,i10] = ind2sub(size(count),find(count>0));    
        domain = i1*10^0+i2*10^1+i2*10^3+i4*10^4+i5*10^5+i6*10^6+i7*10^7+i8*10^8+i9*10^9;   
    otherwise
         print("Truncating domain to first 8 input bands")
        [i1,i2,i3,i4,i5,i6,i7,i8] = ind2sub(size(count),find(count>0));    
        domain = i1*10^0+i2*10^1+i2*10^3+i4*10^4+i5*10^5+i6*10^6+i7*10^7+i8*10^8+i9*10^9+i10*10^10; 
end
return

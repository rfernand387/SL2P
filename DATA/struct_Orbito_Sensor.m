...
% Landsat 5 TM
Orbit.LANDSAT5.Altitude    = 705.0;
Orbit.LANDSAT5.Inclinaison = 98.22*pi/180;
Orbit.LANDSAT5.Period      = 16*1440/501;
Orbit.LANDSAT5.Beta_0      = 0;
Orbit.LANDSAT5.Beta_Alpha  = 16/501;
Orbit.LANDSAT5.Scan        = 8.16*pi/180;
Orbit.LANDSAT5.Heure       = 9.75;
Orbit.LANDSAT5.Duree       = 16;


% Landsat 7 ETM+
Orbit.LANDSAT7.Altitude    = 701;
Orbit.LANDSAT7.Inclinaison = 98.21*pi/180;
Orbit.LANDSAT7.Period      = 16*1440/501;
Orbit.LANDSAT7.Beta_0      = 0;
Orbit.LANDSAT7.Beta_Alpha  = 16/501;
Orbit.LANDSAT7.Scan        = 8.16*pi/180;
Orbit.LANDSAT7.Heure       = 10.0;
Orbit.LANDSAT7.Duree       = 16;

% Landsat 8
Orbit.LANDSAT8.Altitude    = 705.0;
Orbit.LANDSAT8.Inclinaison = 98.22*pi/180;
Orbit.LANDSAT8Period      = 16*1440/501;
Orbit.LANDSAT8.Beta_0      = 0;
Orbit.LANDSAT8.Beta_Alpha  = 16/501;
Orbit.LANDSAT8.Scan        = 8.16*pi/180;
Orbit.LANDSAT8.Heure       = 10:00;
